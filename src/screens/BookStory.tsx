...
// Párrafos con URLs directas de GIFs de Milk y Mocha distribuidos a los costados
const letterContent = [
  ...
  { text: "Tú fuiste una de esas personas.", bear: "https://media.tenor.com/mOXZ6-U6V1YAAAAi/milk-and-mocha-bear.gif", position: "left" },
  ...
  { text: "Poco a poco te fuiste convirtiendo en alguien importante para mí, sin prisas, sin darme cuenta, simplemente sucedió.", bear: "https://media.tenor.com/2N6m78q_jS8AAAAi/milk-and-mocha.gif", position: "right" },
  ...
  { text: "Una persona que me enseñó que las conexiones más bonitas nacen cuando uno es simplemente uno mismo.", bear: "https://media.tenor.com/D4s6-407jWAAAAAi/milk-and-mocha-bear-phone.gif", position: "left" },
  ...
  { text: "Porque estabas tú. Y eso bastó para que ese día encontrara un lugar especial en mi memoria.", bear: "https://media.tenor.com/c6xY-oIuV9UAAAAi/milk-and-mocha-hug.gif", position: "right" },
  ...
  { text: "Y quiero que sepas que lo entiendo.", bear: "https://media.tenor.com/J8bU9k8c2L0AAAAi/milk-and-mocha-cute.gif", position: "left" },
  ...
  { text: "No es un secreto; es un deseo sincero que nace de todo lo bueno que veo en ti.", bear: "https://media.tenor.com/79h5wX6j6-UAAAAi/milk-and-mocha-love.gif", position: "right" },
  { text: "Pero también sería injusto pedirte que corras cuando tu corazón necesita caminar.", bear: null, position: null },
  { text: "Por eso no quiero que este detalle sea una presión ni una manera de convencerte de algo. Quiero que sea exactamente lo contrario: un recordatorio de que eres una persona muy especial para mí, independientemente del nombre que tenga lo nuestro hoy.", bear: "https://media.tenor.com/2t1p9r1Y6kMAAAAi/milk-and-mocha-happy.gif", position: "left" },
  ...
  { text: "Mientras tanto, seguiré disfrutando de conocerte, de hablar contigo, de reír contigo y de valorar cada instante que compartimos.", bear: "https://media.tenor.com/1Z0K2-1x538AAAAi/milk-and-mocha.gif", position: "right" },
  ...
  { text: "Hoy no te escribo porque seas mi novia.", bear: "https://media.tenor.com/k9d6k8l3-08AAAAi/milk-and-mocha-heart.gif", position: "left" },
  ...
  { text: "Solo quiero que sepas que aquí hay alguien que te aprecia de verdad, que cree en ti y que, mientras ambos sigamos eligiendo compartir este camino, estará feliz de seguir conociéndote.", bear: "https://media.tenor.com/8x2L0-J8bU9AAAAi/milk-and-mocha-bears.gif", position: "right" },
...
export const BookStory = () => {
  ...
  return (
    <section className="flex flex-col items-center justify-start w-full relative z-10 py-20">
      ...
      {/* Párrafos con ositos dispuestos a los costados */}
      <div className="max-w-4xl w-full px-6 flex flex-col gap-12">
        {letterContent.map((item, index) => (
          <motion.div
            ...
            className={`min-h-[55vh] flex items-center justify-center w-full relative ${
              item.position === 'left' ? 'flex-row-reverse md:flex-row-reverse' : 
            ...
            <div className={`max-w-2xl ${!item.bear ? 'text-center mx-auto' : 'text-left'}`}>
              <p
                className={`font-serif leading-[2.2] tracking-[0.02em] ${
                  item.text.length < 50 
                    ? "text-2xl md:text-4xl text-white italic drop-shadow-md text-center" 
                    : "text-lg md:text-[22px] text-gray-300 font-light"
                }`}
              >
                {item.text}
              </p>
